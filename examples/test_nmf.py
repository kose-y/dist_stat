...
from dist_stat.application.nmf import NMF
import argparse
import os
...
if __name__=='__main__':
    parser = argparse.ArgumentParser(description="NMF with multiplicative algorithm")
    ...
    nmf_driver = NMF(m, int(args.r), TType, init_from_master=args.set_from_master)
